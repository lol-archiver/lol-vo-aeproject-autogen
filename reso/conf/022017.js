module.exports = {
	...
	lines: {
		'D692D737': {
			mark: '“Virtue”是西部天使艾希的战马，直译为“美德”，雌性（原文“her”）。由于没找到官方的音译用字，姑且译为“弗秋”',
			afters: [
				{
					side: 'left',
		...
		'E10DDD36': { mark: '“Jeremiah James”是厄加特在西部皮肤宇宙中的真名。\n语音中翻译为“杰里米亚”，皮肤传记中翻译为“耶利米”，都是常用的译名' },
		'C2E4E872': { mark: '“Jeremiah James”是厄加特在西部皮肤宇宙中的真名。\n语音中翻译为“杰里米亚”，皮肤传记中翻译为“耶利米”，都是常用的译名' },
	}
};