export default {
	...
	events: {
		...
		'[移动:初次][友方:使用:皮肤:光明哨兵 格雷福斯]':
			{ target: '${C.dirAutogen}/reso/icon/Graves/35.png' },
		'[初遇:皮肤:光明哨兵 格雷福斯]':
			{ target: '${C.dirAutogen}/reso/icon/Graves/35.png' },
		'[击杀:皮肤:光明哨兵 格雷福斯]':
			{ target: '${C.dirAutogen}/reso/icon/Graves/35.png' },
		...
		'[击杀:英雄:赛娜]':
			{ target: '${C.dirAutogen}/reso/icon/Senna/0.png' },
		'[初遇:英雄:波比]':
			{ target: '${C.dirAutogen}/reso/icon/Poppy/0.png' },
		'[击杀:英雄:波比]':
			{ target: '${C.dirAutogen}/reso/icon/Poppy/0.png' },
		'[初遇:英雄:伊芙琳]':
		...
		'[使用:Q技能:闪避突袭]':
			{ skill: '${C.dirAutogen}/reso/icon/Vayne/Q.png' },
		'[使用:E技能:恶魔审判]':
			{ skill: '${C.dirAutogen}/reso/icon/Vayne/E.png' },
		'[使用:E技能:恶魔审判:击退至地形]':
			{ skill: '${C.dirAutogen}/reso/icon/Vayne/E.png' },
		'[使用:R技能:终极时刻]':
			{ skill: '${C.dirAutogen}/reso/icon/Vayne/R.png' },
	},
	lines: {
		'176A745C': {
			afters: [
				{
					side: 'left',
					head: '${C.dirAutogen}/reso/icon/Olaf/25.png',
					line: 'ヽ(💢｀皿´💢)ノ',
					hideEvent: true,
				},
			]
