		...
		'3BBD747C': [
			{
				...
				side: 'left',
				duration: 0.4,
				head: '${C.path.project.autogen}reso/icons/Thresh/5.png',
				line: 'ヾ(｡｀Д´｡)',
			},
		],
		'999FEC1D': [
			{
				...
				side: 'left',
				duration: 0.4,
				head: '${C.path.project.autogen}reso/icons/Malphite/6.png',
				line: '( ￣ー￣)',
			},
		],
		'42FE9751': [
			{
				...
				side: 'left',
				duration: 0.4,
				head: '${C.path.project.autogen}reso/icons/Jhin/5.png',
				line: '( ‵o′)凸',
			},
		],
	}
