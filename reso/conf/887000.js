module.exports = {
	...
	event: {
		...
		'[击杀:英雄:墨菲特]':
			{ target: '${C.path.project.autogen}reso/icon/Malphite/0.png' },
		'[初遇:英雄:奥拉夫]':
			{ target: '${C.path.project.autogen}reso/icon/Olaf/0.png' },
		'[击杀:英雄:奥拉夫]':
			{ target: '${C.path.project.autogen}reso/icon/Olaf/0.png' },
		'[初遇:英雄:奥恩]':
		...
		'[使用:Q技能:快刀剪乱]':
			{ skill: '${C.path.project.autogen}reso/icon/Gwen/Q.png' },
		'[使用:W技能:丝缕缠流]':
			{ skill: '${C.path.project.autogen}reso/icon/Gwen/W.png' },
		'[使用:E技能:断续疾走]':
			{ skill: '${C.path.project.autogen}reso/icon/Gwen/E.png' },
		'[使用:R技能:引针簇射:第一次施放]':
			{ skill: '${C.path.project.autogen}reso/icon/Gwen/R.png' },
		'[使用:R技能:引针簇射:第二次施放]':
			{ skill: '${C.path.project.autogen}reso/icon/Gwen/R.png' },
		'[使用:R技能:引针簇射:第三次施放]':
			{ skill: '${C.path.project.autogen}reso/icon/Gwen/R.png' },
	...
	lines: {
		...
		'B03B803E': {
			mark: '原文第一段“It\'s called the Hallowed Mist. ”。\n“它被称之为圣霭”\n这里第一段语音是翻译错的，“the Hallowed Mist”在技能文本中翻译为“圣霭”，在英雄传记中翻译为“圣洁的浓雾”。\n但不是黑雾（the Black Mist）',
		},
	}
};