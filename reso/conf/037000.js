export default {
	...
	event: {
		...
		'[击杀:英雄:塔里克]':
			{ target: '${C.dirAutogen}/reso/icon/Taric/0.png' },
		'[初遇:英雄:赵信]':
			{ target: '${C.dirAutogen}/reso/icon/XinZhao/0.png' },
		'[击杀:英雄:赵信]':
			{ target: '${C.dirAutogen}/reso/icon/XinZhao/0.png' },

		'[使用:Q技能:英勇赞美诗]':
			{ skill: '${C.dirAutogen}/reso/icon/Sona/Q.png' },
		'[使用:W技能:坚毅咏叹调]':
			{ skill: '${C.dirAutogen}/reso/icon/Sona/W.png' },
		'[使用:E技能:迅捷奏鸣曲]':
			{ skill: '${C.dirAutogen}/reso/icon/Sona/E.png' },
		'[使用:R技能:狂舞终乐章]':
			{ skill: '${C.dirAutogen}/reso/icon/Sona/R.png' },
		...
		'FE1E197D': [
			{
				...
				side: 'left',
				duration: 0.4,
				head: '${C.dirAutogen}/reso/icon/Irelia/0.png',
				line: 'φ(゜▽゜*)♪',
			},
		],
		'19EBF42A': [
