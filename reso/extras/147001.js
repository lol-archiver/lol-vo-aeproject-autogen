module.exports = {
	...
	event: {
		...
		'[使用:Q技能:清籁穿云]':
			{ skill: '${C.path.project.autogen}reso/icons/Seraphine/Q.png' },
		'[使用:Q技能:清籁穿云:回响]':
			{ skill: '${C.path.project.autogen}reso/icons/Seraphine/Q_3.png' },
		'[使用:W技能:聚合心声]':
			{ skill: '${C.path.project.autogen}reso/icons/Seraphine/W.png' },
		'[使用:W技能:聚合心声:回响]':
			{ skill: '${C.path.project.autogen}reso/icons/Seraphine/W_3.png' },
		'[使用:E技能:增幅节拍]':
			{ skill: '${C.path.project.autogen}reso/icons/Seraphine/E.png' },
		'[使用:E技能:增幅节拍:回响]':
			{ skill: '${C.path.project.autogen}reso/icons/Seraphine/E_3.png' },
		'[使用:R技能:炫音返场]':
			{ skill: '${C.path.project.autogen}reso/icons/Seraphine/R.png' },
	},
	lines: {
		'B7BC600A': [
			{
