...
this.OffsetSplashBackground = C.video.isLandscape ? 0 : offsetSplashBackground;
...
this.AddOpener = () => {
	...
	const scaleSplash3 = (C.video.isLandscape ? widthGrid / widthSplash : heightGrid3 / heightSplash) * 100;
	...
	const xBL = splashBL.position.value[0] + (C.video.isLandscape ? 0 : infoBL[1]);
	...
	const xTR = splashTR.position.value[0] + (C.video.isLandscape ? 0 : infoTR[1]);
	...
	const xBR = splashBR.position.value[0] + (C.video.isLandscape ? 0 : infoBR[1]);
	...
	const xTC = splashTC.position.value[0] + (C.video.isLandscape ? 0 : infoTC[1]);
	...
	const xBC = splashBC.position.value[0] + (C.video.isLandscape ? 0 : infoBC[1]);
	...
	const xMC = splashMC.position.value[0] + (C.video.isLandscape ? 0 : infoMC[1]);
