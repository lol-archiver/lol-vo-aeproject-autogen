...
P.addOpener2 = function addOpener2() {
	...
	var splashTL = compTL.layers.add(F(splashesOpener[1][0], T.dirFootage), D.opener); splashTL.name = 'splash-opener-tl';
	...
	var splashBL = compBL.layers.add(F(infoBL[0], T.dirFootage), D.opener); splashBL.name = 'splash-opener-bl';
	...
	var splashTR = compTR.layers.add(F(infoTR[0], T.dirFootage), D.opener); splashTR.name = 'splash-opener-tr';
	...
	var splashBR = compBR.layers.add(F(infoBR[0], T.dirFootage), D.opener); splashBR.name = 'splash-opener-br';
	...
	var splashTC = compTC.layers.add(F(infoTC[0], T.dirFootage), D.opener); splashTC.name = 'splash-opener-tc';
	...
	var splashBC = compBC.layers.add(F(infoBC[0], T.dirFootage), D.opener); splashBC.name = 'splash-opener-bc';
	...
	var splashMC = compMC.layers.add(F(infoMC[0], T.dirFootage), D.opener); splashMC.name = 'splash-opener-mc';
	...
	// logo-font
	var logoFont = layerOpener.add(F(dirSplash + 'logo.png', T.dirFootage), 6); logoFont.name = 'logo-font';
	...
	// logo-image
	var logoImage = layerOpener.add(F(dirSplash + 'jugong480-500.mp4', T.dirFootage), 6); logoImage.name = 'logo-image';
